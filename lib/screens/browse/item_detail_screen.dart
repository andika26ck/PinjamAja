        ...
        body: CustomScrollView(
          slivers: [
            ...
            SliverAppBar(
              expandedHeight: 300,
              pinned: true,
              iconTheme: const IconThemeData(color: Colors.white), // Ubah icon back jadi putih
                  ...
                  children: [
                    ...
                    PageView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        // Berikan tag Hero HANYA pada gambar pertama (index 0)
                        if (index == 0) {
                          imageWidget = Hero(
                        ...
                        // Tambahkan overlay gradient hitam transparan di atas gambar
                        // biar tombol back panah putih tetep keliatan jelas
                        return Stack(
                          fit: StackFit.expand,
                          children: [
                            imageWidget,
                            Positioned(
                              ...
                              left: 0,
                              right: 0,
                              height: 100, // Gradasi tipis dari atas
                              child: Container(
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          '${_currentImageIndex + 1}/${item.imageUrls.isNotEmpty ? item.imageUrls.length : 1}',
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'Nama Pemilik', // Bisa dikembangkan ambil dari tabel profiles
                                  style: Theme.of(context)
                                      .textTheme
                                      .titleSmall
                          ...
                          ElevatedButton(
                            onPressed: () => context.go(
                              '/chat/${item.ownerId}?bookingId=dummy', // Perlu passing bookingId real nanti
